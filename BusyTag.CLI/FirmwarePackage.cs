...
public class FirmwarePackage : IDisposable
{
    ...
    public static FirmwarePackage FromEmbeddedResources()
    {
        ...
        ExtractResource(assembly, "BusyTag.CLI.Firmware.bootloader.bin", Path.Combine(tempDir, "bootloader.bin"));
        ExtractResource(assembly, "BusyTag.CLI.Firmware.partition-table.bin", Path.Combine(tempDir, "partition-table.bin"));
        ExtractResource(assembly, "BusyTag.CLI.Firmware.file_server.bin", Path.Combine(tempDir, "file_server.bin"));
        ExtractResource(assembly, "BusyTag.CLI.Firmware.ota_data_initial.bin", Path.Combine(tempDir, "ota_data_initial.bin"));
